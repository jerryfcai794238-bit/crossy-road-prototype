...
export const CONFIG = {
  ...
  PLAYER: { MAX_HP: 100, DAMAGE_INVULNERABILITY: 2, MAX_STAMINA: 100, STAMINA_MOVE_COST: 2, STAMINA_RECOVERY_PER_SECOND: 20 }, TRAFFIC: { CAR_DAMAGE_BASE: 10, CAR_DAMAGE_SPEED_SCALE: 8, CAR_DAMAGE_CAP: 60, TRAIN_DAMAGE: 70 },
